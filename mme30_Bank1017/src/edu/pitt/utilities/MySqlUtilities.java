...
public class MySqlUtilities implements DbUtilities {
	...
	private String dbName = "mme30_bank1017"; // default database name
	private String dbUserName = "mme30"; // login name for the database server
	private String dbPassword = "3741418"; // password for the database server
	...
	/**
	 * Used for closing db connection after queries.
	 */
